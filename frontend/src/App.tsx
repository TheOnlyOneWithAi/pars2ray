...
const pages: Page[] = ['dashboard', 'nodes', 'ai-inbounds', 'users', 'settings']
...
export default function App() {
  ...
  if (pageName === 'dashboard') content = <DashboardPage {...common} dashboard={dashboard} nodes={nodes} routes={[]} telemetry={telemetry} trafficBreakdown={trafficBreakdown} openPage={(target) => setPage(target === 'routes' ? 'ai-inbounds' : 'nodes')}/>
