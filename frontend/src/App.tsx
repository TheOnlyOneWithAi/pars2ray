...
export default function App() {
  ...
  if (pageName === 'dashboard') content = <ControlDashboardPage {...common} dashboard={dashboard!} nodes={nodes} telemetry={telemetry} trafficBreakdown={trafficBreakdown} openPage={setPage}/>
