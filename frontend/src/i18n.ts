...
const dictionaries = {
  en: {
    ...
    networkTraffic: 'Network traffic', trafficBreakdown: 'Traffic by node', nodeHealth: 'Node health', routePosture: 'Route posture', noActiveRoute: 'No active route', protected: 'Protected', normal: 'Normal', national: 'National',
  ...
  fa: {
    ...
    networkTraffic: 'ترافیک شبکه', trafficBreakdown: 'تفکیک ترافیک نودها', nodeHealth: 'سلامت نودها', routePosture: 'وضعیت مسیر', noActiveRoute: 'مسیر فعالی وجود ندارد', protected: 'محافظت‌شده', normal: 'عادی', national: 'شبکه ملی',
  ...
  ru: {
    ...
    networkTraffic: 'Сетевой трафик', trafficBreakdown: 'Трафик по узлам', nodeHealth: 'Состояние узлов', routePosture: 'Состояние маршрута', noActiveRoute: 'Нет активного маршрута', protected: 'Защищено', normal: 'Обычный', national: 'Национальный',
